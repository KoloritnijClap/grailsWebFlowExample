	...
	<body>
		...
		<div id="show-product" class="content scaffold-show" role="main">
			...
			<ol class="property-list product">
				...
				<g:if test="${productInstance?.currencyCode}">
				<li class="fieldcontain">
					<span id="currencyCode-label" class="property-label"><g:message code="product.currencyCode.label" default="Currency Code" /></span>
					
						<span class="property-value" aria-labelledby="currencyCode-label"><g:fieldValue bean="${productInstance}" field="currencyCode"/></span>
			...
			<g:form url="[resource:productInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					...
					<g:link class="edit" controller="purchase" action="purchase" params="[productId:productInstance.id]"><g:message code="buy" /></g:link>
				</fieldset>
			</g:form>
		</div>
	</body>
